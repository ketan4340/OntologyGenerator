...
class ParserDemo {
  ...
  public static void demoAPI(LexicalizedParser lp) {
    ...
    String[] sent = {"A", "self-propelled", "vehicle", "is", "a", "motor", "vehicle", "or", "road", "vehicle", "that", "does", "not", "operate", "on", "rails", "."};
    ...
    String sent2 = "A self-propelled vehicle is a motor vehicle or road vehicle that does not operate on rails.";
